...
const CouponCard: React.FC<CouponCardProps> = ({
  ...
  return (
    <div className="bg-white rounded-lg w-full flex mb-3 border border-gray-200 h-full">
      <div className="flex-1 m-auto p-3">
        <p className="text-red-600 text-xl font-bold text-center">{title}</p>
      </div>
      <div className="flex-1 m-auto border-l-2 border-gray-300 border-dashed p-3">
